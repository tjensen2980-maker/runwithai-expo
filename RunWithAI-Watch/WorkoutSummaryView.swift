      ...
      var body: some View {
                ScrollView {
                              VStack(spacing: 12) {
                                                ...
                                                HStack(spacing: 16) {
                                                                      summaryStatView(
                                                                                                value: workoutManager.formatDistance(workoutManager.distance),
                                                                                                unit: "km",
                                                                                                color: primaryColor
                                                                      )
                                                                      summaryStatView(
                                                                                                value: workoutManager.formatDuration(workoutManager.elapsedSeconds),
                                                                                                unit: "tid",
                                                                                                color: .white
                                                                      )
                                                }
                                                ...
                                                HStack(spacing: 16) {
                                                                      summaryStatView(
                                                                                                value: workoutManager.formatPace(workoutManager.averagePace),
                                                                                                unit: "gns. pace",
                                                                                                color: .orange
                                                                      )
                                                                      summaryStatView(
                                                                                                value: workoutManager.formatHeartRate(),
                                                                                                unit: "gns. puls",
                                                                                                color: .red
                                                                      )
                                                }
                                                ...
                                                HStack(spacing: 16) {
                                                                      summaryStatView(
                                                                                                value: workoutManager.formatCalories(),
                                                                                                unit: "kcal",
                                                                                                color: .orange
                                                                      )
                                                                      summaryStatView(
                                                                                                value: workoutManager.formatCadence(),
                                                                                                unit: "spm",
                                                                                                color: .cyan
                                                                      )
                                                }
                                                ...
                                                if workoutManager.totalAscent > 0 {
                                                                      HStack(spacing: 16) {
                                                                                                summaryStatView(
                                                                                                                              value: workoutManager.formatElevation(workoutManager.totalAscent),
                                                                                                                              unit: "stigning",
                                                                                                                              color: .green
                                                                                                )
                                                                                                summaryStatView(
                                                                                                                              value: workoutManager.formatElevation(workoutManager.totalDescent),
                                                                                                                              unit: "fald",
                                                                                                                              color: .purple
                                                                                                )
                                                                      }
