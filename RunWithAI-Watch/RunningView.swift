...
struct RunningView: View {
                ...
                private var mainDataScreen: some View {
                                    VStack(spacing: 4) {
                                                            ...
                                                            // Target pace indicator (Garmin-style)
                                                            ...
                                                            HStack(spacing: 10) {
                                                                                        ...
                                                                                        VStack(spacing: 2) {
                                                                                                                        Text(workoutManager.formatPace(
                                                                                                                                                            workoutManager.smoothedPace > 0 ? workoutManager.smoothedPace : workoutManager.currentPace
                                                                                                                        ))
                                                                                                                        .font(.system(size: 19, weight: .semibold, design: .rounded))
                ...
                // MARK: - Pace Status Banner (Garmin-style)
                private var paceStatusBanner: some View {
                                    HStack(spacing: 4) {
                                                            if workoutManager.paceStatus != .noTarget {
                                                                                        Image(systemName: workoutManager.paceStatus.icon)
                                                                                            .font(.system(size: 10))
                                                                                        Text(workoutManager.paceStatus.label)
                                                                                        ...
                                                                                        ForEach(1...5, id: \.self) { zone in
                                                                                                                                        VStack(spacing: 2) {
                                                                                                                                                                            RoundedRectangle(cornerRadius: 2)
                                                                                                                                                                                .fill(zone <= workoutManager.heartRateZone()
                                                                                                                                                                                                                        ? zoneColor(zone) : Color.gray.opacity(0.2))
                                                                                                                                                                                .frame(height: 8)
                                    ...
                                    VStack(spacing: 5) {
                                                            ...
                                                            if workoutManager.targetPaceMax > 0 {
                                                                                        detailRow(icon: "target", label: "Mål-tempo",
                                                                                                                      value: workoutManager.formatPace(workoutManager.targetPaceMin) + "-" +
                                                                                                                             workoutManager.formatPace(workoutManager.targetPaceMax),
                ...
                private var paceColor: Color {
                                    switch workoutManager.paceStatus {
                                                        case .tooFast:  return .green
                                                        case .onTarget: return primaryColor
                                                        case .tooSlow:  return .red
                                                        case .noTarget: return .orange
                                    }
                }
