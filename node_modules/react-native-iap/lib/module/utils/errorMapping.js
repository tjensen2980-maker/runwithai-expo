 ...
 */
export const DUPLICATE_PURCHASE_CODE = 'duplicate-purchase';
...
export function isDuplicatePurchaseError(error) {
...
export function isRecoverableError(error) {
  const recoverableErrors = [ErrorCode.NetworkError, ErrorCode.RemoteError, ErrorCode.ServiceError, ErrorCode.Interrupted, ErrorCode.ServiceDisconnected, ErrorCode.BillingUnavailable, ErrorCode.QueryProduct, ErrorCode.InitConnection, ErrorCode.SyncError, ErrorCode.ConnectionClosed, DUPLICATE_PURCHASE_CODE];
  const code = extractCode(error);
