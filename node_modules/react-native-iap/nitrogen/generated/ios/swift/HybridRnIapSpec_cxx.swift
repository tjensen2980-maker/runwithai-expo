...
open class HybridRnIapSpec_cxx {
   ...
   */
  @inline(__always)
  public func equals(other: HybridRnIapSpec_cxx) -> Bool {
  ...
  // Methods
  @inline(__always)
  public final func initConnection(config: bridge.std__optional_std__variant_nitro__NullType__InitConnectionConfig__) -> bridge.Result_std__shared_ptr_Promise_bool___ {
    do {
      let __result = try self.__implementation.initConnection(config: { () -> Variant_NullType_InitConnectionConfig? in
        if bridge.has_value_std__optional_std__variant_nitro__NullType__InitConnectionConfig__(config) {
          let __unwrapped = bridge.get_std__optional_std__variant_nitro__NullType__InitConnectionConfig__(config)
          return { () -> Variant_NullType_InitConnectionConfig in
            let __variant = bridge.std__variant_nitro__NullType__InitConnectionConfig_(__unwrapped)
  ...
  @inline(__always)
  public final func requestPurchase(request: NitroPurchaseRequest) -> bridge.Result_std__shared_ptr_Promise_std__variant_nitro__NullType__PurchaseAndroid__PurchaseIOS__std__vector_std__variant_PurchaseAndroid__PurchaseIOS______ {
    do {
      let __result = try self.__implementation.requestPurchase(request: request)
      let __resultCpp = { () -> bridge.std__shared_ptr_Promise_std__variant_nitro__NullType__PurchaseAndroid__PurchaseIOS__std__vector_std__variant_PurchaseAndroid__PurchaseIOS_____ in
        let __promise = bridge.create_std__shared_ptr_Promise_std__variant_nitro__NullType__PurchaseAndroid__PurchaseIOS__std__vector_std__variant_PurchaseAndroid__PurchaseIOS_____()
        let __promiseHolder = bridge.wrap_std__shared_ptr_Promise_std__variant_nitro__NullType__PurchaseAndroid__PurchaseIOS__std__vector_std__variant_PurchaseAndroid__PurchaseIOS_____(__promise)
        __result
          .then({ __result in __promiseHolder.resolve({ () -> bridge.std__variant_nitro__NullType__PurchaseAndroid__PurchaseIOS__std__vector_std__variant_PurchaseAndroid__PurchaseIOS___ in
              switch __result {
                case .first(let __value):
                  return bridge.create_std__variant_nitro__NullType__PurchaseAndroid__PurchaseIOS__std__vector_std__variant_PurchaseAndroid__PurchaseIOS___(margelo.nitro.NullType.null)
                case .second(let __value):
                  return bridge.create_std__variant_nitro__NullType__PurchaseAndroid__PurchaseIOS__std__vector_std__variant_PurchaseAndroid__PurchaseIOS___(__value)
                case .third(let __value):
                  return bridge.create_std__variant_nitro__NullType__PurchaseAndroid__PurchaseIOS__std__vector_std__variant_PurchaseAndroid__PurchaseIOS___(__value)
                case .fourth(let __value):
                  return bridge.create_std__variant_nitro__NullType__PurchaseAndroid__PurchaseIOS__std__vector_std__variant_PurchaseAndroid__PurchaseIOS___({ () -> bridge.std__vector_std__variant_PurchaseAndroid__PurchaseIOS__ in
      ...
      return bridge.create_Result_std__shared_ptr_Promise_std__variant_nitro__NullType__PurchaseAndroid__PurchaseIOS__std__vector_std__variant_PurchaseAndroid__PurchaseIOS______(__resultCpp)
    } catch (let __error) {
      let __exceptionPtr = __error.toCpp()
      return bridge.create_Result_std__shared_ptr_Promise_std__variant_nitro__NullType__PurchaseAndroid__PurchaseIOS__std__vector_std__variant_PurchaseAndroid__PurchaseIOS______(__exceptionPtr)
    }
  }
  ...
  @inline(__always)
  public final func getAppTransactionIOS() -> bridge.Result_std__shared_ptr_Promise_std__variant_nitro__NullType__std__string____ {
    do {
  ...
  @inline(__always)
  public final func requestPromotedProductIOS() -> bridge.Result_std__shared_ptr_Promise_std__variant_nitro__NullType__NitroProduct____ {
    do {
      let __result = try self.__implementation.requestPromotedProductIOS()
      let __resultCpp = { () -> bridge.std__shared_ptr_Promise_std__variant_nitro__NullType__NitroProduct___ in
        let __promise = bridge.create_std__shared_ptr_Promise_std__variant_nitro__NullType__NitroProduct___()
        let __promiseHolder = bridge.wrap_std__shared_ptr_Promise_std__variant_nitro__NullType__NitroProduct___(__promise)
        __result
          .then({ __result in __promiseHolder.resolve({ () -> bridge.std__variant_nitro__NullType__NitroProduct_ in
              switch __result {
                case .first(let __value):
                  return bridge.create_std__variant_nitro__NullType__NitroProduct_(margelo.nitro.NullType.null)
                case .second(let __value):
                  return bridge.create_std__variant_nitro__NullType__NitroProduct_(__value)
              }
            }().variant) })
          .catch({ __error in __promiseHolder.reject(__error.toCpp()) })
        return __promise
      }()
      return bridge.create_Result_std__shared_ptr_Promise_std__variant_nitro__NullType__NitroProduct____(__resultCpp)
    } catch (let __error) {
      let __exceptionPtr = __error.toCpp()
      return bridge.create_Result_std__shared_ptr_Promise_std__variant_nitro__NullType__NitroProduct____(__exceptionPtr)
    }
  }
  
  @inline(__always)
  public final func getPromotedProductIOS() -> bridge.Result_std__shared_ptr_Promise_std__variant_nitro__NullType__NitroProduct____ {
    do {
  ...
  @inline(__always)
  public final func beginRefundRequestIOS(sku: std.string) -> bridge.Result_std__shared_ptr_Promise_std__variant_nitro__NullType__std__string____ {
    do {
  ...
  @inline(__always)
  public final func subscriptionStatusIOS(sku: std.string) -> bridge.Result_std__shared_ptr_Promise_std__variant_nitro__NullType__std__vector_NitroSubscriptionStatus_____ {
    do {
      let __result = try self.__implementation.subscriptionStatusIOS(sku: String(sku))
      let __resultCpp = { () -> bridge.std__shared_ptr_Promise_std__variant_nitro__NullType__std__vector_NitroSubscriptionStatus____ in
        let __promise = bridge.create_std__shared_ptr_Promise_std__variant_nitro__NullType__std__vector_NitroSubscriptionStatus____()
        let __promiseHolder = bridge.wrap_std__shared_ptr_Promise_std__variant_nitro__NullType__std__vector_NitroSubscriptionStatus____(__promise)
        __result
          .then({ __result in __promiseHolder.resolve({ () -> bridge.std__variant_nitro__NullType__std__vector_NitroSubscriptionStatus__ in
              switch __result {
                case .first(let __value):
                  return bridge.create_std__variant_nitro__NullType__std__vector_NitroSubscriptionStatus__(margelo.nitro.NullType.null)
                case .second(let __value):
                  return bridge.create_std__variant_nitro__NullType__std__vector_NitroSubscriptionStatus__({ () -> bridge.std__vector_NitroSubscriptionStatus_ in
                    var __vector = bridge.create_std__vector_NitroSubscriptionStatus_(__value.count)
                    for __item in __value {
                      __vector.push_back(__item)
                    }
                    return __vector
      ...
      return bridge.create_Result_std__shared_ptr_Promise_std__variant_nitro__NullType__std__vector_NitroSubscriptionStatus_____(__resultCpp)
    } catch (let __error) {
      let __exceptionPtr = __error.toCpp()
      return bridge.create_Result_std__shared_ptr_Promise_std__variant_nitro__NullType__std__vector_NitroSubscriptionStatus_____(__exceptionPtr)
    }
  }
  
  @inline(__always)
  public final func currentEntitlementIOS(sku: std.string) -> bridge.Result_std__shared_ptr_Promise_std__variant_nitro__NullType__NitroPurchase____ {
    do {
      let __result = try self.__implementation.currentEntitlementIOS(sku: String(sku))
      let __resultCpp = { () -> bridge.std__shared_ptr_Promise_std__variant_nitro__NullType__NitroPurchase___ in
        let __promise = bridge.create_std__shared_ptr_Promise_std__variant_nitro__NullType__NitroPurchase___()
        let __promiseHolder = bridge.wrap_std__shared_ptr_Promise_std__variant_nitro__NullType__NitroPurchase___(__promise)
        __result
          .then({ __result in __promiseHolder.resolve({ () -> bridge.std__variant_nitro__NullType__NitroPurchase_ in
              switch __result {
                case .first(let __value):
      ...
      return bridge.create_Result_std__shared_ptr_Promise_std__variant_nitro__NullType__NitroPurchase____(__resultCpp)
    } catch (let __error) {
      let __exceptionPtr = __error.toCpp()
      return bridge.create_Result_std__shared_ptr_Promise_std__variant_nitro__NullType__NitroPurchase____(__exceptionPtr)
    }
  }
  
  @inline(__always)
  public final func latestTransactionIOS(sku: std.string) -> bridge.Result_std__shared_ptr_Promise_std__variant_nitro__NullType__NitroPurchase____ {
    do {
  ...
  @inline(__always)
  public final func getTransactionJwsIOS(sku: std.string) -> bridge.Result_std__shared_ptr_Promise_std__variant_nitro__NullType__std__string____ {
    do {
  ...
  @inline(__always)
  public final func createAlternativeBillingTokenAndroid(sku: bridge.std__optional_std__variant_nitro__NullType__std__string__) -> bridge.Result_std__shared_ptr_Promise_std__variant_nitro__NullType__std__string____ {
    do {
      let __result = try self.__implementation.createAlternativeBillingTokenAndroid(sku: { () -> Variant_NullType_String? in
        if bridge.has_value_std__optional_std__variant_nitro__NullType__std__string__(sku) {
          let __unwrapped = bridge.get_std__optional_std__variant_nitro__NullType__std__string__(sku)
  ...
  @inline(__always)
  public final func isEligibleForExternalPurchaseCustomLinkIOS() -> bridge.Result_std__shared_ptr_Promise_bool___ {
    do {
      let __result = try self.__implementation.isEligibleForExternalPurchaseCustomLinkIOS()
      let __resultCpp = { () -> bridge.std__shared_ptr_Promise_bool__ in
        let __promise = bridge.create_std__shared_ptr_Promise_bool__()
        let __promiseHolder = bridge.wrap_std__shared_ptr_Promise_bool__(__promise)
        __result
  ...
  @inline(__always)
  public final func getExternalPurchaseCustomLinkTokenIOS(tokenType: Int32) -> bridge.Result_std__shared_ptr_Promise_ExternalPurchaseCustomLinkTokenResultIOS___ {
    do {
      let __result = try self.__implementation.getExternalPurchaseCustomLinkTokenIOS(tokenType: margelo.nitro.iap.ExternalPurchaseCustomLinkTokenTypeIOS(rawValue: tokenType)!)
      let __resultCpp = { () -> bridge.std__shared_ptr_Promise_ExternalPurchaseCustomLinkTokenResultIOS__ in
        let __promise = bridge.create_std__shared_ptr_Promise_ExternalPurchaseCustomLinkTokenResultIOS__()
        let __promiseHolder = bridge.wrap_std__shared_ptr_Promise_ExternalPurchaseCustomLinkTokenResultIOS__(__promise)
        __result
          .then({ __result in __promiseHolder.resolve(__result) })
          .catch({ __error in __promiseHolder.reject(__error.toCpp()) })
        return __promise
      }()
      return bridge.create_Result_std__shared_ptr_Promise_ExternalPurchaseCustomLinkTokenResultIOS___(__resultCpp)
    } catch (let __error) {
      let __exceptionPtr = __error.toCpp()
      return bridge.create_Result_std__shared_ptr_Promise_ExternalPurchaseCustomLinkTokenResultIOS___(__exceptionPtr)
    }
  }
  
  @inline(__always)
  public final func showExternalPurchaseCustomLinkNoticeIOS(noticeType: Int32) -> bridge.Result_std__shared_ptr_Promise_ExternalPurchaseCustomLinkNoticeResultIOS___ {
    do {
      let __result = try self.__implementation.showExternalPurchaseCustomLinkNoticeIOS(noticeType: margelo.nitro.iap.ExternalPurchaseCustomLinkNoticeTypeIOS(rawValue: noticeType)!)
      let __resultCpp = { () -> bridge.std__shared_ptr_Promise_ExternalPurchaseCustomLinkNoticeResultIOS__ in
        let __promise = bridge.create_std__shared_ptr_Promise_ExternalPurchaseCustomLinkNoticeResultIOS__()
        let __promiseHolder = bridge.wrap_std__shared_ptr_Promise_ExternalPurchaseCustomLinkNoticeResultIOS__(__promise)
        __result
          .then({ __result in __promiseHolder.resolve(__result) })
          .catch({ __error in __promiseHolder.reject(__error.toCpp()) })
        return __promise
      }()
      return bridge.create_Result_std__shared_ptr_Promise_ExternalPurchaseCustomLinkNoticeResultIOS___(__resultCpp)
    } catch (let __error) {
      let __exceptionPtr = __error.toCpp()
      return bridge.create_Result_std__shared_ptr_Promise_ExternalPurchaseCustomLinkNoticeResultIOS___(__exceptionPtr)
    }
  }
}
