...
namespace margelo::nitro::iap {
   ...
   */
  struct NitroPurchaseResult final {
  public:
  ...
  public:
    friend bool operator==(const NitroPurchaseResult& lhs, const NitroPurchaseResult& rhs) = default;
  };
  ...
  struct JSIConverter<margelo::nitro::iap::NitroPurchaseResult> final {
    static inline margelo::nitro::iap::NitroPurchaseResult fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      ...
      return margelo::nitro::iap::NitroPurchaseResult(
        ...
        JSIConverter<std::optional<std::string>>::fromJSI(runtime, obj.getProperty(runtime, PropNameIDCache::get(runtime, "debugMessage"))),
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::iap::NitroPurchaseResult& arg) {
      ...
      obj.setProperty(runtime, PropNameIDCache::get(runtime, "debugMessage"), JSIConverter<std::optional<std::string>>::toJSI(runtime, arg.debugMessage));
    ...
    static inline bool canConvert(jsi::Runtime& runtime, const jsi::Value& value) {
      ...
      if (!JSIConverter<std::optional<std::string>>::canConvert(runtime, obj.getProperty(runtime, PropNameIDCache::get(runtime, "debugMessage")))) return false;
