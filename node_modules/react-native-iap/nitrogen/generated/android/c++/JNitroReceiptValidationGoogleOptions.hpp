...
namespace margelo::nitro::iap {
  ...
  public:
    ...
    NitroReceiptValidationGoogleOptions toCpp() const {
      ...
      static const auto fieldIsSub = clazz->getField<JVariant_NullType_Boolean>("isSub");
      jni::local_ref<JVariant_NullType_Boolean> isSub = this->getFieldValue(fieldIsSub);
      ...
      return NitroReceiptValidationGoogleOptions(
        ...
        isSub != nullptr ? std::make_optional(isSub->toCpp()) : std::nullopt,
  ...
  public:
    ...
    static jni::local_ref<JNitroReceiptValidationGoogleOptions::javaobject> fromCpp(const NitroReceiptValidationGoogleOptions& value) {
      using JSignature = JNitroReceiptValidationGoogleOptions(jni::alias_ref<jni::JString>, jni::alias_ref<JVariant_NullType_Boolean>, jni::alias_ref<jni::JString>, jni::alias_ref<jni::JString>, jni::alias_ref<jni::JString>);
      static const auto clazz = javaClassStatic();
      static const auto create = clazz->getStaticMethod<JSignature>("fromCpp");
      return create(
        clazz,
        jni::make_jstring(value.accessToken),
        value.isSub.has_value() ? JVariant_NullType_Boolean::fromCpp(value.isSub.value()) : nullptr,
