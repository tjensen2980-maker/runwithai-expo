...
namespace margelo::nitro::iap {
  ...
  public:
    ...
    NitroReceiptValidationResultIOS toCpp() const {
      ...
      static const auto fieldLatestTransaction = clazz->getField<JVariant_NullType_NitroPurchase>("latestTransaction");
      jni::local_ref<JVariant_NullType_NitroPurchase> latestTransaction = this->getFieldValue(fieldLatestTransaction);
  ...
  public:
    ...
    static jni::local_ref<JNitroReceiptValidationResultIOS::javaobject> fromCpp(const NitroReceiptValidationResultIOS& value) {
      using JSignature = JNitroReceiptValidationResultIOS(jboolean, jni::alias_ref<jni::JString>, jni::alias_ref<jni::JString>, jni::alias_ref<JVariant_NullType_NitroPurchase>);
      static const auto clazz = javaClassStatic();
      ...
      return create(
        ...
        value.latestTransaction.has_value() ? JVariant_NullType_NitroPurchase::fromCpp(value.latestTransaction.value()) : nullptr
      );
    }
  };
