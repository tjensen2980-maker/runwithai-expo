...
namespace margelo::nitro::iap {
  ...
  public:
    ...
    NitroRentalDetailsAndroid toCpp() const {
      ...
      static const auto fieldRentalExpirationPeriod = clazz->getField<JVariant_NullType_String>("rentalExpirationPeriod");
      jni::local_ref<JVariant_NullType_String> rentalExpirationPeriod = this->getFieldValue(fieldRentalExpirationPeriod);
      ...
      return NitroRentalDetailsAndroid(
        rentalExpirationPeriod != nullptr ? std::make_optional(rentalExpirationPeriod->toCpp()) : std::nullopt,
  ...
  public:
    ...
    static jni::local_ref<JNitroRentalDetailsAndroid::javaobject> fromCpp(const NitroRentalDetailsAndroid& value) {
      using JSignature = JNitroRentalDetailsAndroid(jni::alias_ref<JVariant_NullType_String>, jni::alias_ref<jni::JString>);
      static const auto clazz = javaClassStatic();
      static const auto create = clazz->getStaticMethod<JSignature>("fromCpp");
      return create(
        clazz,
        value.rentalExpirationPeriod.has_value() ? JVariant_NullType_String::fromCpp(value.rentalExpirationPeriod.value()) : nullptr,
