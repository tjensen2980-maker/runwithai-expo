...
abstract class HybridRnIapSpec: HybridObject() {
  ...
  @DoNotStrip
  @Keep
  abstract fun initConnection(config: Variant_NullType_InitConnectionConfig?): Promise<Boolean>
  ...
  @DoNotStrip
  @Keep
  abstract fun getAppTransactionIOS(): Promise<Variant_NullType_String>
  
  @DoNotStrip
  @Keep
  abstract fun requestPromotedProductIOS(): Promise<Variant_NullType_NitroProduct>
  
  @DoNotStrip
  @Keep
  abstract fun getPromotedProductIOS(): Promise<Variant_NullType_NitroProduct>
  ...
  @DoNotStrip
  @Keep
  abstract fun beginRefundRequestIOS(sku: String): Promise<Variant_NullType_String>
  
  @DoNotStrip
  @Keep
  abstract fun subscriptionStatusIOS(sku: String): Promise<Variant_NullType_Array_NitroSubscriptionStatus_>
  
  @DoNotStrip
  @Keep
  abstract fun currentEntitlementIOS(sku: String): Promise<Variant_NullType_NitroPurchase>
  
  @DoNotStrip
  @Keep
  abstract fun latestTransactionIOS(sku: String): Promise<Variant_NullType_NitroPurchase>
  ...
  @DoNotStrip
  @Keep
  abstract fun getTransactionJwsIOS(sku: String): Promise<Variant_NullType_String>
  ...
  @DoNotStrip
  @Keep
  abstract fun createAlternativeBillingTokenAndroid(sku: Variant_NullType_String?): Promise<Variant_NullType_String>
  ...
  @DoNotStrip
  @Keep
  abstract fun isEligibleForExternalPurchaseCustomLinkIOS(): Promise<Boolean>
  
  @DoNotStrip
  @Keep
  abstract fun getExternalPurchaseCustomLinkTokenIOS(tokenType: ExternalPurchaseCustomLinkTokenTypeIOS): Promise<ExternalPurchaseCustomLinkTokenResultIOS>
  
  @DoNotStrip
  @Keep
  abstract fun showExternalPurchaseCustomLinkNoticeIOS(noticeType: ExternalPurchaseCustomLinkNoticeTypeIOS): Promise<ExternalPurchaseCustomLinkNoticeResultIOS>
