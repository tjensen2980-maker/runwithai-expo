                      ...
                      if command -v pod >/dev/null 2>&1; then
                        POD_BIN="$(command -v pod)"
                          ...
                          brew install cocoapods || true
                            ...
                            sed -i '' 's/CURRENT_PROJECT_VERSION = [^;]*;/CURRENT_PROJECT_VERSION = 171;/g' "$PBXPROJ"
                                                                                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                                                                                        "info": {
                                                                                                                                                                                                                                                                                                                                            "author": "xcode",
                                                                                                                                                                                                                                                                                                                                                "version": 1
                                                                                                                                                                                                                                                                                                                                                  ...
                                                                                                                                                                                                                                                                                                                                                  EXPORT_DIR="$IOS_DIR/RunWithAI/expo-bundle"
                                                                                                                                                                                                                                                                                                                                                  
                                                                                                                                                                                                                                                                                                                                                  node_modules/.bin/expo export \
                                                                                                                                                                                                                                                                                                                                                    --platform ios \
                                                                                                                                                                                                                                                                                                                                                      --output-dir "$EXPORT_DIR"
                                                                                                                                                                                                                                                                                                                                                      
                                                                                                                                                                                                                                                                                                                                                      # Find the generated bundle file - expo export produces .hbc (Hermes bytecode) or .js
                                                                                                                                                                                                                                                                                                                                                      ...
                                                                                                                                                                                                                                                                                                                                                      if [ -n "$BUNDLE_FILE" ]; then
                                                                                                                                                                                                                                                                                                                                                        cp "$BUNDLE_FILE" "$BUNDLE_OUTPUT"
                                                                                                                                                                                                                                                                                                                                                          echo "main.jsbundle created from: $BUNDLE_FILE"
                                                                                                                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                                                                                                                            echo "ERROR: No bundle file found in $EXPORT_DIR/bundles"
                                                                                                                                                                                                                                                                                                                                                              ls -la "$EXPORT_DIR/bundles/" || true
                                                                                                                                                                                                                                                                                                                                                                exit 1
                                                                                                                                                                                                                                                                                                                                                                fi
                                                                                                                                                                                                                                                                                                                                                                fi
